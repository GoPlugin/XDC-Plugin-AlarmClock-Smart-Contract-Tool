            ...
            <div class="col-sm-12 col-md-5">
                <div class="card" style="width: 25rem;">
                    <div class="card-body">
                        ...
                        <p class="card-text fs-6"><small> Create a time locked contract using Plugin to lockup XDC for a certain amount of time before transferring it to the receiver </small> </p>
